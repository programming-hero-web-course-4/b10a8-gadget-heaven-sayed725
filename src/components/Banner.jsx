    ...
    return (
       <div className="relative">
         <div className="flex flex-col justify-center items-center bg-[#9538E2] gap-8 rounded-b-2xl">
            ...
            <Link to='/dashboard'><button className="btn bg-white text-[#9538E2] font-bold mb-[270px] rounded-3xl">Shop Now</button></Link>
        </div>
        <div className="pb-5 relative bottom-[220px]">
            <img className="h-[560px] w-8/12 mx-auto p-2 border-2 border-white rounded-2xl" src="/banner.jpg" alt="" />
        </div>
       </div>
    );
};

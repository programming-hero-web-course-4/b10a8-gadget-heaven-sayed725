...
const WishListDetails = ({ wishList }) => {
  const { product_title, product_image, price, specification } = wishList;
  return (
    <div>
        ...
        <div className="flex justify-between items-center">
          <div className="flex gap-8 items-center">
            ...
            <div className="flex flex-col justify-between gap-5">
              ...
              <button className="btn w-[160px] rounded-full bg-[#9538E2] text-white hover:text-black">Add to Card</button>
            </div>
          </div>
        </div>
      </div>
